// SAURYANSHU KHANAL, CSC-161, Demonstration 4, 2nd March 2022.
//WORDLE
...
// PART 1: GETTING THE INPUT FROM THE USER
// Gets userinput
...
//Part 7, I have already implemented Option 2, that checks if the userinput is valid or not, i.e, if it is five characters, in the play_game function.
//get_guess is prompted again if the string length is not correct.